...
<!------------------------------------------------Start Registration form--------------------------------------------------->
			...
			<div class="col-md-12 col-md-offset-2" id="search_detail">
				...
				<input type="date" name="from_date" class="form-control" id="from_date" value="2022-12-03" oninput="for_list();" />
				</div>
				</div>
				...
				<div class="form-group">
				<label>To Date</label>
				<input type="date" name="to_date" class="form-control" id="to_date" value="2022-12-03" oninput="for_list();" />
				</div>
				</div>
